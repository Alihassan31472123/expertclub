...
import 'package:career_edu/newconwasa.dart';
...
class wasa extends StatefulWidget {
  const wasa({super.key});

  @override
  State<wasa> createState() => _wasaState();
}
...
class _wasaState extends State<wasa> {
  @override
     ...
     Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.push(context, (MaterialPageRoute(builder: (context)=>newwasa())));
                        },
                        child: Container(
                          height: 50,
                          width: 170,
