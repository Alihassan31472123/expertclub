...
class kelectric extends StatefulWidget {
  const kelectric({super.key});

  @override
  State<kelectric> createState() => _kelectricState();
}
...
class _kelectricState extends State<kelectric> {
  @override
